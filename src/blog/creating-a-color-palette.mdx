...
We then evaluated whether or not it would work for our users. We continued to tweak our colors through rounds of UI prototyping, and color-blind user interviews. Tools such as <ExternalLink to="https://www.getstark.co/">Stark</ExternalLink> and <ExternalLink to="https://projects.susielu.com/viz-palette">Viz Palette</ExternalLink> were incredibly helpful in this regard.
